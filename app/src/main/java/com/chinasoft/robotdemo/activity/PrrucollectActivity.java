...
//        mSuperPopupWindow.setFocusable(true);
    ...
    private void saveRbLocationInfo(float x, float y, float scaleRuler) {
        ...
        SharedPrefHelper.putFloat(PrrucollectActivity.this, "scale", scale);
        SharedPrefHelper.putFloat(PrrucollectActivity.this, "xo", xo);
        SharedPrefHelper.putFloat(PrrucollectActivity.this, "yo", yo);
        SharedPrefHelper.putFloat(PrrucollectActivity.this, "realXo", realXo);
        SharedPrefHelper.putFloat(PrrucollectActivity.this, "realYo", realYo);
        initX = nowX;
        initY = nowY;
        SharedPrefHelper.putFloat(PrrucollectActivity.this, "initX", initX);
        SharedPrefHelper.putFloat(PrrucollectActivity.this, "initY", initY);
        initStart(xo, yo);
    }
